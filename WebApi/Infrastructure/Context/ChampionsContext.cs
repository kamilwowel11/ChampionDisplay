...
namespace WebApi.Infrastructure.Context
{
  public class ChampionsContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        new ChampionEntity() { Id = 2, FirstName = "Akali", DefaultPosition = "Midlane", Bio = "Abandoning the Kinkou Order and her title of the Fist of Shadow, Akali now strikes alone, ready to be the deadly weapon her people need.", PictureUrl = "assets/Akali.png", AvatarUrl = "assets/Akali.png" },
        ...
        new ChampionEntity() { Id = 6, FirstName = "Volibear", DefaultPosition = "Jungle", Bio = "The thunderous demigod known as the Thousand-Pierced Bear is the battle-spirit of the Freljord.", PictureUrl = "assets/Volibear.png", AvatarUrl = "assets/Volibear.png" },
